...
*For Linux and Mac Users*: Once you open the project in Eclipse, you must go to `YOUR_PATH/simpfi/src/main/java/com/simpfi/sumo/wrapper/SumoConnectionManager.java` and change "sumo-gui" in 
